...
console.log(allFrequencies.length)
...
fTonleiter( Tonart1, Grundton1, Oktavlage1);

    // Abrufen des richtigen Grundtons
document.querySelector("#selectNote").addEventListener("change", function (a) {
        Grundton1 = a.target.options[a.target.selectedIndex].value;
        Grundton1 = parseInt(Grundton1);
        fTonleiter( Tonart1, Grundton1, Oktavlage1);
        console.log(Tonleiter)
    ...
    // Abrufen der richtigen Tonart
document.querySelector("#selectScale").addEventListener("change", function (e) {
        Tonart1 = e.target.options[e.target.selectedIndex].value;
        fTonleiter( Tonart1, Grundton1, Oktavlage1);
        console.log(Tonleiter)
        
        console.log(playNote(10));
});
...
function fTonleiter (Tonart, Grundton, Oktavlage){

    //Dur
if (Tonart == 1) {

    Tonleiter = [
        Grundton + Oktavlage*12,
        Grundton + Oktavlage*12 + 2,
        Grundton + Oktavlage*12 + 4,
        Grundton + Oktavlage*12 + 5,
        Grundton + Oktavlage*12 + 7,
        Grundton + Oktavlage*12 + 9,
        Grundton + Oktavlage*12 + 11   
    ];
}   
//Moll
else if (Tonart == 2) {
    ...
    Tonleiter = [
        Grundton + Oktavlage*12,
        Grundton + Oktavlage*12 + 2,
        Grundton + Oktavlage*12 + 3,
        Grundton + Oktavlage*12 + 5,
        Grundton + Oktavlage*12 + 7,
        Grundton + Oktavlage*12 + 8,
        Grundton + Oktavlage*12 + 10   
    ];
}
//Pentatonik
else if (Tonart == 3) {
...
function playNote (brightness) {

    let Note = Math.round((brightness/127)*Tonleiter.length);

    return Tonleiter[Note];
